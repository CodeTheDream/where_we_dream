...
class StatesControllerTest < ActionController::TestCase
  ...
  #     post :create, state: { abbreviation: @state.abbreviation, description: @state.description, in_state: @state.in_state, name: @state.name }
  #   end
  #
  ...
  #   patch :update, id: @state, state: { abbreviation: @state.abbreviation, description: @state.description, in_state: @state.in_state, name: @state.name }
  #   assert_redirected_to state_path(assigns(:state))
  # end
  #
